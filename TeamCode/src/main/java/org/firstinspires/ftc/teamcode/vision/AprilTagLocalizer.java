...
public class AprilTagLocalizer {
    ...
    public AprilTagLocalizer(HardwareMap hardwareMap) {
        ...
        aprilTag  = buildAprilTagProcessor(cameraPosition, cameraOrientation);
...
//                .build();
        ...
        builder.enableLiveView(true); //TODO: in match turn this off
...
//        visionPortal.setProcessorEnabled(aprilTag, true);
    ...
    public Pose2d update(Telemetry telemetry) {
        ...
        closestTag = currentDetections.get(0);
        ...
        double x = closestTag.robotPose.getPosition().x;
        double y = closestTag.robotPose.getPosition().y;
        double heading = Math.toDegrees(closestTag.robotPose.getOrientation().getYaw());
